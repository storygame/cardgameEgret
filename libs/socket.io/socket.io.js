                        ...
                        function runInContext(context, exports) {
                            ...
                            if (!has("json")) {
                                ...
                                if (!has("json-parse")) {
                                    ...
                                    var get = function (value) { var results, hasMembers; if (value == "$") {
                                        abort();
